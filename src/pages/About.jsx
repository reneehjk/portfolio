...
import logoInsight from '../assets/about/logo-insight.webp'
...
const logos = [
  { src: logoInsight, alt: 'Insight', cover: false },
        ...
        <div className="hidden sm:flex items-start px-5 md:px-10 py-20">
          ...
          <div className="flex flex-col gap-5 pt-0 lg:pt-[46px] pb-10 max-w-2xl ml-[96px]">
            ...
            <div className="flex flex-col gap-4 text-body text-text-secondary leading-[1.8] opacity-0 animate-[fadeUp_0.85s_0.45s_cubic-bezier(0.16,1,0.3,1)_forwards]">
              <p>i&apos;m a design engineer. based in toronto, graduated from queen&apos;s university in april 2026 with a degree in computing.</p>
              <p>i started with code. i got into design because it was problem solving with a creative layer. now i'm at the intersection of both and that&apos;s exactly where i want to be.</p>
              <p>i co-founded the <a href="https://www.instagram.com/queens.ux/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">queen&apos;s ux club<ArrowUpRightIcon className="w-2.5 h-2.5" /></a> to teach other students user research, figma, interaction design, and more. then i went and did it at <a href="https://www.insight.com/en_US/home.html" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">insight<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>, <a href="https://periodaisle.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">aisle<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>, <a href="https://studiostonecreative.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">studiostone<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>, <a href="https://kimchistudios.ca/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">kimchi studios<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>, and <a href="https://nezdek.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">nezdek<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>.</p>
            </div>
          </div>
        </div>
        ...
        <div className="sm:hidden">
          ...
          <div className="border-t border-half border-border-default mt-10 px-5 pt-8 pb-10">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-4 text-body text-text-secondary leading-[1.8] opacity-0 animate-[fadeUp_0.85s_0.45s_cubic-bezier(0.16,1,0.3,1)_forwards]">
                <p>i&apos;m a design engineer. based in toronto, graduating from queen&apos;s university in april 2026 with a degree in computing.</p>
                ...
                <p>i co-founded the <a href="https://www.instagram.com/queens.ux/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">queen&apos;s ux club<ArrowUpRightIcon className="w-2.5 h-2.5" /></a> to teach other students what i was figuring out: user research, figma, interaction design. then i went and did it at <a href="https://www.insight.com/en_US/home.html" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">insight<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>, <a href="https://periodaisle.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">aisle<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>, <a href="https://studiostonecreative.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">studiostone<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>, and <a href="https://nezdek.com/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-0.5 text-text-primary hover:text-accent-default transition-colors duration-150">nezdek<ArrowUpRightIcon className="w-2.5 h-2.5" /></a>.</p>
              </div>
            </div>
          </div>
        </div>
